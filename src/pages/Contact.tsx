...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e?: React.SyntheticEvent) => {
    // allow calling from onClick or onSubmit
    e?.preventDefault?.();
    ...
    try {
      // construct mailto link to open user's default mail client with prefilled subject & body
      const to = 'ryanedinson@gmail.com';
      const subject = `Contact from ${formData.name}`;
      const body = `Name: ${formData.name}\nEmail: ${formData.email}\n\n${formData.message}`;
      const mailto = `mailto:${to}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;

      // open the default mail client. Using location.href is widely supported.
      window.location.href = mailto;

      setSubmitStatus({ type: 'success', message: "Opening your email client..." });
      // optionally clear the form after opening
  ...
  const handleDownloadResume = () => {
    // Robust resume download helper
    // Prefer the PUBLIC_URL path so placing the resume under `public/resume/...` works.
    const publicPath = `${process.env.PUBLIC_URL || ''}/resume/edison-mwendwa-resume.pdf`;

    // Try to initiate a normal download via anchor. If that doesn't work (some browsers or CORS),
    // fall back to fetching the file and using a blob URL, and finally open in a new tab.
    (async () => {
      try {
        ...
        // ignore and try full fetch below
      }
  ...
  return (
    <>
      <style>{`
        ...
        .s-label { display: flex; align-items: center; gap: 12px; margin-bottom: 1.4rem; }
        ...
        .form-label {
          ...
          letter-spacing: 0.08em; text-transform: uppercase;
          color: #aaa; margin-bottom: 0.55rem;
        }
      ...
      <div className="contact-page">
        ...
        <div style={{ maxWidth:'1140px', margin:'0 auto', padding:'5rem 2.5rem 7rem' }}>
          ...
          <div
            ...
            style={{ display:'grid', gridTemplateColumns:'340px 1fr', gap:'2rem', marginTop:'4rem', alignItems:'start' }}
          >
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'1.8rem' }}>
              ...
              {/* Profile card */}
              <FadeUp delay={0.05}>
                <div className="glass-card" style={{ padding:'2.2rem', textAlign:'center' }}>
                  <div className="profile-img-ring" style={{ margin:'0 auto 1.2rem' }}>
                    <img
                  ...
                  <h2 className="serif" style={{ fontSize:'1.5rem', fontWeight:700, color:'#1a1a2e', marginBottom:'0.3rem' }}>
                    Edison Mwendwa
                  </h2>
                  <p style={{ fontSize:'0.82rem', color:'#aaa', letterSpacing:'0.05em', margin:'0 0 1rem' }}>
                    Software Engineer · Nairobi
                  </p>

                  <div style={{ display:'flex', justifyContent:'center', gap:'0.55rem', marginBottom:'1.2rem' }}>
                    <div style={{
              ...
              <FadeUp delay={0.12}>
                <div className="glass-card" style={{ padding:'1.8rem 2rem' }}>
                  ...
                  <div className="contact-item">
                    ...
                    <div>
                      <div style={{ fontSize:'0.7rem', color:'#bbb', letterSpacing:'0.08em', textTransform:'uppercase', marginBottom:2 }}>Email</div>
                      <div style={{ fontSize:'0.9rem', color:'#1a1a2e', fontWeight:400 }}>ryanedinson@gmail.com</div>
                    </div>
                  </div>
                  ...
                  <div className="contact-item">
                    ...
                    <div>
                      <div style={{ fontSize:'0.7rem', color:'#bbb', letterSpacing:'0.08em', textTransform:'uppercase', marginBottom:2 }}>Phone</div>
                      <div style={{ fontSize:'0.9rem', color:'#1a1a2e', fontWeight:400 }}>+254 742 644 921</div>
                    </div>
                  </div>
                  ...
                  <div className="contact-item" style={{ border:'none' }}>
                    ...
                    <div>
                      <div style={{ fontSize:'0.7rem', color:'#bbb', letterSpacing:'0.08em', textTransform:'uppercase', marginBottom:2 }}>Location</div>
                      <div style={{ fontSize:'0.9rem', color:'#1a1a2e', fontWeight:400 }}>Nairobi, Kenya</div>
                    </div>
                  </div>
                </div>
              </FadeUp>
              ...
              <FadeUp delay={0.2}>
                <div className="glass-card" style={{ padding:'1.8rem 2rem' }}>
                  <div className="s-label" style={{ marginBottom:'1.2rem' }}>
                    <div className="s-label-line"/>
            ...
            {/* ── Right: Form ── */}
            <FadeUp delay={0.1}>
              <div className="glass-card" style={{ padding:'3rem 3.2rem' }}>
                <div className="s-label">
                  <div className="s-label-line"/>
                ...
                <p style={{ fontSize:'0.9rem', color:'#aaa', fontWeight:300, marginBottom:0 }}>
                ...
                <p style={{
                  ...
                  textAlign:'center', marginTop:'1.4rem', marginBottom:0,
                  fontWeight:300
                }}>
